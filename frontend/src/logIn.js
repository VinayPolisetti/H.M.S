          ...
          <Box
            ...
            <Form
              ...
              onSubmit={({ value }) => {
                ...
                if(value.isDoc===true&&value.isAdmin===true)
                {
                  window.alert("You cannot tick both the checkboxes,Choose one of them");
                }
                else if (value.isDoc === true) {
                ...
                {
                  fetch("http://localhost:3001/checkadminlogin?email=" + value.email +
                    "&password=" + value.password)
                    .then(res => res.json())
                    .then(res => {
                      if (res.data.length === 0) {
