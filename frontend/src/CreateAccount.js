  ...
  render() {
    ...
    return (
      <Grommet theme={theme} full>
        <AppBar>
          <a style={{ color: 'inherit', textDecoration: 'inherit',alignContent: 'center' ,alignItems: 'center',justifyContent: 'center'}} href="/"><Heading level='3' margin='none'>HMS</Heading></a>
        </AppBar>
          ...
          <Box width="medium">
            ...
            <Form
                  ...
                  .then(res => {
                    ...
                    if ((res.data[0])) {
                      ...
                      fetch("http://localhost:3001/makeAccount?name=" + value.firstName + "&lastname=" + value.lastName + "&email=" + value.email
                        ...
                        + "&conditions=" + value.conditions + "&medications=" + value.medications + "&surgeries=" + value.surgeries + "&phno=" + value.phno);
              ...
              <FormField
                ...
                required
                validate={{ regexp: /^[0-9]{10}$/ }} />
              <FormField
                label="Password"
                name="password"
                placeholder="Password"
                required
                validate={{ regexp:  /^[a-zA-Z0-9!@#$%^&*]{8,}$/ }} />
